...
OBJ_NAMES=boot.o main.o os_entry.o VGA_text.o idt.o idt_e.o pic.o serial.o ring_buffer.o
LINK_OBJ_NAMES=main.o os_entry.o VGA_text.o idt_e.o idt.o pic.o serial.o ring_buffer.o
